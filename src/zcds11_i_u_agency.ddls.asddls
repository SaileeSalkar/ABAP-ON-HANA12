@AbapCatalog.sqlViewName: 'ZSQL11_I'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'CDS FOR AGENCY FOR FIORI'
@Metadata.ignorePropagatedAnnotations: true
define view ZCDS11_I_U_agency as select from /dmo/agency association[1] to I_Country as _country on
$projection.country_code = _country.Country
{
